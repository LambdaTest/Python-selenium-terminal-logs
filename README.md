...
If you want to upload and view Python-selenium terminal logs on TestMu AI (Formerly LambdaTest), you can follow the below steps. You can refer to sample test repo [here](https://github.com/LambdaTest/python-selenium-sample).
...
The terminal logs can be uploaded using the TestMu AI (Formerly LambdaTest) API.

### Step 1: Authorise using credentials

Go to the TestMu AI (Formerly LambdaTest) API webpage.
