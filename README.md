# Run Python Selenium Terminal Logs Tests on TestMu AI (Formerly LambdaTest)
...
If you want to upload and view Python-selenium terminal logs on TestMu AI (Formerly TestMu AI (Formerly LambdaTest)), you can follow the below steps. You can refer to sample test repo [here](https://github.com/LambdaTest/python-selenium-sample).
...
The terminal logs can be uploaded using the TestMu AI (Formerly TestMu AI (Formerly LambdaTest)) API.

### Step 1: Authorise using credentials

Go to the TestMu AI (Formerly TestMu AI (Formerly LambdaTest)) API webpage.
Use the **Authorise** button to fill your valid TestMu AI (Formerly TestMu AI (Formerly LambdaTest)) credentials to authenticate your API requests.

### Step 2: 

Go to the session section and select the terminal logs POST request. Provide your session-id and select the log file you want to upload (json,xml, txt). 

Note: You can also do this with a CURL command like so (replace session-id, auth code and filename):
